...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230403203323_AdicionadoColunasTabelaNotas') THEN
    ALTER TABLE "tab_notasFicais" RENAME COLUMN "NumeroDocumento" TO "AvulsoFinalidade";
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230403203323_AdicionadoColunasTabelaNotas') THEN
    ALTER TABLE "tab_notasFicais" ADD "Autorizador" text NOT NULL DEFAULT '';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230403203323_AdicionadoColunasTabelaNotas') THEN
    ALTER TABLE "tab_notasFicais" ADD "TimeId" integer NOT NULL DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230403203323_AdicionadoColunasTabelaNotas') THEN
    ALTER TABLE "tab_notasFicais" ADD CONSTRAINT "FK_tab_notasFicais_tab_time_TimeId" FOREIGN KEY ("TimeId") REFERENCES tab_time ("Id") ON DELETE CASCADE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230403203323_AdicionadoColunasTabelaNotas') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20230403203323_AdicionadoColunasTabelaNotas', '7.0.4');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230403203908_AdicionadoTabelaDocumentos') THEN
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230403203908_AdicionadoTabelaDocumentos') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20230403203908_AdicionadoTabelaDocumentos', '7.0.4');
    END IF;
END $EF$;
COMMIT;
