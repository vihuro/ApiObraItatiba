...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503015316_criadoTabelasParaConhecimentosObra') THEN
    CREATE TABLE "tab_ConhecimentosObra" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "NumeroDocumento" integer NOT NULL,
        "DataEmissao" timestamp with time zone NOT NULL,
        "CodigoTransportadora" text NOT NULL,
        "Transpotadora" text NOT NULL,
        "ValorFrete" numeric NOT NULL,
        "UsuarioCadastroId" integer NOT NULL,
        "DataHoraCadastro" timestamp with time zone NOT NULL,
        "UsuarioAlteracaoId" integer NOT NULL,
        "DataHotaAlteracao" timestamp with time zone NOT NULL,
        CONSTRAINT "PK_tab_ConhecimentosObra" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_tab_ConhecimentosObra_tab_Usuario_UsuarioAlteracaoId" FOREIGN KEY ("UsuarioAlteracaoId") REFERENCES "tab_Usuario" ("Id") ON DELETE CASCADE,
        CONSTRAINT "FK_tab_ConhecimentosObra_tab_Usuario_UsuarioCadastroId" FOREIGN KEY ("UsuarioCadastroId") REFERENCES "tab_Usuario" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503015316_criadoTabelasParaConhecimentosObra') THEN
    CREATE TABLE "tab_NotasConhecimentoObra" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "NumeroNota" integer NOT NULL,
        "Fornecedor" text NULL,
        "UsuarioCadastroId" integer NOT NULL,
        "ConhecimentoObraId" integer NOT NULL,
        "DataHoraCadastro" timestamp with time zone NOT NULL,
        "UsuarioAlteracaoId" integer NOT NULL,
        "DataHoraAlteracao" timestamp with time zone NOT NULL,
        CONSTRAINT "PK_tab_NotasConhecimentoObra" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_tab_NotasConhecimentoObra_tab_ConhecimentosObra_Conheciment~" FOREIGN KEY ("ConhecimentoObraId") REFERENCES "tab_ConhecimentosObra" ("Id") ON DELETE CASCADE,
        CONSTRAINT "FK_tab_NotasConhecimentoObra_tab_Usuario_UsuarioAlteracaoId" FOREIGN KEY ("UsuarioAlteracaoId") REFERENCES "tab_Usuario" ("Id") ON DELETE CASCADE,
        CONSTRAINT "FK_tab_NotasConhecimentoObra_tab_Usuario_UsuarioCadastroId" FOREIGN KEY ("UsuarioCadastroId") REFERENCES "tab_Usuario" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503015316_criadoTabelasParaConhecimentosObra') THEN
    CREATE TABLE "tab_ParcelaConhecimentoObra" (
        "Id" integer GENERATED BY DEFAULT AS IDENTITY,
        "NumeroParcela" text NOT NULL,
        ...
        "DataHoraCadastro" timestamp with time zone NOT NULL,
        "UsuarioAlteracaoId" integer NOT NULL,
        CONSTRAINT "PK_tab_ParcelaConhecimentoObra" PRIMARY KEY ("Id"),
        CONSTRAINT "FK_tab_ParcelaConhecimentoObra_tab_ConhecimentosObra_Conhecime~" FOREIGN KEY ("ConhecimentoObraId") REFERENCES "tab_ConhecimentosObra" ("Id") ON DELETE CASCADE,
        CONSTRAINT "FK_tab_ParcelaConhecimentoObra_tab_Usuario_UsuarioAlteracaoId" FOREIGN KEY ("UsuarioAlteracaoId") REFERENCES "tab_Usuario" ("Id") ON DELETE CASCADE,
        CONSTRAINT "FK_tab_ParcelaConhecimentoObra_tab_Usuario_UsuarioCadastroId" FOREIGN KEY ("UsuarioCadastroId") REFERENCES "tab_Usuario" ("Id") ON DELETE CASCADE
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503015316_criadoTabelasParaConhecimentosObra') THEN
    CREATE INDEX "IX_tab_ConhecimentosObra_UsuarioAlteracaoId" ON "tab_ConhecimentosObra" ("UsuarioAlteracaoId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503015316_criadoTabelasParaConhecimentosObra') THEN
    CREATE INDEX "IX_tab_ConhecimentosObra_UsuarioCadastroId" ON "tab_ConhecimentosObra" ("UsuarioCadastroId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503015316_criadoTabelasParaConhecimentosObra') THEN
    CREATE INDEX "IX_tab_NotasConhecimentoObra_ConhecimentoObraId" ON "tab_NotasConhecimentoObra" ("ConhecimentoObraId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503015316_criadoTabelasParaConhecimentosObra') THEN
    CREATE INDEX "IX_tab_NotasConhecimentoObra_UsuarioAlteracaoId" ON "tab_NotasConhecimentoObra" ("UsuarioAlteracaoId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503015316_criadoTabelasParaConhecimentosObra') THEN
    CREATE INDEX "IX_tab_NotasConhecimentoObra_UsuarioCadastroId" ON "tab_NotasConhecimentoObra" ("UsuarioCadastroId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503015316_criadoTabelasParaConhecimentosObra') THEN
    CREATE INDEX "IX_tab_ParcelaConhecimentoObra_ConhecimentoObraId" ON "tab_ParcelaConhecimentoObra" ("ConhecimentoObraId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503015316_criadoTabelasParaConhecimentosObra') THEN
    CREATE INDEX "IX_tab_ParcelaConhecimentoObra_UsuarioAlteracaoId" ON "tab_ParcelaConhecimentoObra" ("UsuarioAlteracaoId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503015316_criadoTabelasParaConhecimentosObra') THEN
    CREATE INDEX "IX_tab_ParcelaConhecimentoObra_UsuarioCadastroId" ON "tab_ParcelaConhecimentoObra" ("UsuarioCadastroId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503015316_criadoTabelasParaConhecimentosObra') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20230503015316_criadoTabelasParaConhecimentosObra', '7.0.4');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503143600_CriadoMetodosParaAdicionarConhecimentosObra') THEN
    ALTER TABLE "tab_NotasConhecimentoObra" ADD "DataEmissao" timestamp with time zone NOT NULL DEFAULT TIMESTAMPTZ '-infinity';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503143600_CriadoMetodosParaAdicionarConhecimentosObra') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20230503143600_CriadoMetodosParaAdicionarConhecimentosObra', '7.0.4');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503151140_CriadoChaveEstrangeiraParaTimeEmConhecimentosObra') THEN
    ALTER TABLE "tab_ConhecimentosObra" ADD "TimeId" integer NOT NULL DEFAULT 0;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503151140_CriadoChaveEstrangeiraParaTimeEmConhecimentosObra') THEN
    CREATE INDEX "IX_tab_ConhecimentosObra_TimeId" ON "tab_ConhecimentosObra" ("TimeId");
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503151140_CriadoChaveEstrangeiraParaTimeEmConhecimentosObra') THEN
    ALTER TABLE "tab_ConhecimentosObra" ADD CONSTRAINT "FK_tab_ConhecimentosObra_tab_time_TimeId" FOREIGN KEY ("TimeId") REFERENCES tab_time ("Id") ON DELETE CASCADE;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230503151140_CriadoChaveEstrangeiraParaTimeEmConhecimentosObra') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20230503151140_CriadoChaveEstrangeiraParaTimeEmConhecimentosObra', '7.0.4');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230504173810_AdicionadoColunaAutorizarTabelaConhecimento') THEN
    ALTER TABLE "tab_ConhecimentosObra" ADD "Autorizador" text NOT NULL DEFAULT '';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230504173810_AdicionadoColunaAutorizarTabelaConhecimento') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20230504173810_AdicionadoColunaAutorizarTabelaConhecimento', '7.0.4');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20230505195502_.') THEN
    ALTER TABLE "tab_ConhecimentosObra" ADD "DataEntrada" timestamp with time zone NOT NULL DEFAULT TIMESTAMPTZ '-infinity';
    END IF;
END $EF$;
